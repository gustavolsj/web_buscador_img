...
fileUpload.addEventListener("change", function (e) {
  ...
  async function nearestNeighbors() {
    try {
      ...
      alert(
        '⚠️ Esta imagen no está en la base de datos.\n\nPor favor, selecciona una imagen de la carpeta "images" del proyecto.\n\nLas imágenes disponibles son: 529.jpg, 533.jpg, 1128.jpg, FVCS000135.jpg, etc.'
      );
      // Clear results
      document.getElementById("result_1").setAttribute("src", "");
      document.getElementById("result_2").setAttribute("src", "");
      document.getElementById("result_3").setAttribute("src", "");
      document.getElementById("result_4").setAttribute("src", "");
      document.getElementById("result_5").setAttribute("src", "");
    }
  }
  nearestNeighbors();
});
